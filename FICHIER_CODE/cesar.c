...
// Cette fonction transforme les caractères de la table ASCII en chiffres pour pouvoir manipuler les caractères plus facilement
...
void crypt(const char * message, int key,  char * messageCode){ 
    int position;
    for(int i = 0; message[i] != '\0'; i++){       
